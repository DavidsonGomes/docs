---
title: 'Create'
description: 'Learn how to create and configure a WhatsApp Web (Whatsmeow) instance'
icon: plus
---

# Creating WhatsApp Web Instance

To create a WhatsApp Web instance using Whatsmeow, follow these steps:
...
3. **Channel Selection**  
   Select "WhatsApp Web (Whatsmeow)" from the available channels

<img src="/images/instance/create2.png" alt="Whatsmeow Instance Creation" />
